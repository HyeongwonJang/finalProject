...
public class ListVO {
   ...
   private List<QuestionBoardVO> boardList;
   ...
   public ListVO(List<QuestionBoardVO> boardList, PagingBean pagingBean) {
      super();
      this.boardList = boardList;
      this.pagingBean = pagingBean;
   }
   public ListVO(List<Object> list, List<QuestionBoardVO> boardList,
   ...
   public List<QuestionBoardVO> getBoardList() {
      return boardList;
   }
   public void setBoardList(List<QuestionBoardVO> boardList) {
      this.boardList = boardList;
   }
