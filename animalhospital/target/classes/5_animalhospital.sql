...
-- Hospital
insert into Hospital values(Hospital_id_seq.nextval, 'KOSTA 동물병원', '성남시 분당구 백현동', '031_123_4567');
insert into Hospital values(Hospital_id_seq.nextval, 'TOMCAT 동물병원', '인천시 서구 검암동', '032_123_4568');
insert into Hospital values(Hospital_id_seq.nextval, 'EXCEPTION 동물병원', '서울시 마포구 상암동', '02_123_4569');
insert into Hospital values(Hospital_id_seq.nextval, '임박사동물병원', '성남시 분당구 운중동', '031_123_4567');
insert into Hospital values(Hospital_id_seq.nextval, '송일국 동물병원', '인천시 연수구 송도동', '032_123_4567');
insert into Hospital values(Hospital_id_seq.nextval, 'Kal_Toi Anial Hospital', '서울시 서초구', '032_123_4567');
-- Vet
...
-- Vet_License
insert into Vet values('ImChangJung', '1234','111_1111',2 ,'4');
insert into Vet values('ParBG', '1234', '111_1111', 6, '2');
insert into Vet values('YUNA',  '1234', '111_1111',4,'2');
insert into Vet values('DoctorSong', '1234','111_1111',1, '5');
/*
 * 병원 파트 샘플 디비
 */
-- 몇년 되었나 , ex) 나이, 근속연수,
...
values(Treatment_Record_no.nextval, '2015_10_15', '주사 처방', 3.4, 1, '송이', null, '감기');
insert into Treatment_Record(Treatment_Record_no, Treatment_hours, Treatment_content, Pet_weight, Pet_Owner_no, Pet_name, Vet_License_no, Disease_name)
